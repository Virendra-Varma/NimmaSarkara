 ...
 */
public class XEventItemTouchHelperCallback<T extends ItemTouchHelperAdapter>
    extends ItemTouchHelper.Callback {
  public static final float ALPHA_FULL = 1.0f;
  private T adapter;
  private RecyclerView rv;

  public XEventItemTouchHelperCallback(T adapter, RecyclerView rv) {
  ...
  @Override public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder source,
    ...
    if (adapter instanceof ItemTouchHelperAdapter) {
      ((ItemTouchHelperAdapter) adapter).onItemMove(source.getAdapterPosition(),
  ...
  @Override public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
    if (adapter instanceof ItemTouchHelperAdapter) {
      ((ItemTouchHelperAdapter) adapter).onItemDismiss(viewHolder.getAdapterPosition(), rv);
    }
